...
<head>
  ...
  <title>Kings Branding Consult | Programme Home</title>
	    ...
	    <div class="uk-container">
	      <div class="uk-position-z-index" data-uk-navbar>
	        <div class="uk-navbar-left">
	          <a class="uk-navbar-item uk-logo" href="index-2.html"><img src="img/favicon.png">Kings Branding Consult</a>
	        </div>
				...
				<div data-uk-grid>
					<div class="uk-width-expand@m uk-flex uk-flex-middle uk-light">
						<div>
							...
							<h1 class="uk-heading-small uk-letter-spacing-medium">SMM BLUEPRINT</h1>
							<p class="uk-margin-small-bottom">Earn $183 - $283 monthly from the comfort of your home managing businesses effectively on social media.</p>
							<div class="uk-rating">
								...
								<span>(200)</span>
								<span class="uk-margin-left">200 students enrolled</span>
							</div>
							<p class="uk-margin-xsmall-top">Created by Miracle Peters<span class="uk-margin-left">Last updated</span>
								<time datetime="2020-07-07">July 9 2022</time></p>
						</div>
					</div>
...
<div id="lesson" class="uk-flex-top uk-modal-container" data-uk-modal>
    ...
    uk-border-rounded-large">
		<button class="uk-modal-close-outside" type="button" data-uk-close></button>
    <h2 class="uk-modal-title">Introduction: a UXD Parable</h2>
