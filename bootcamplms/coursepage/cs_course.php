...
<span class="uk-align-right uk-margin-remove-bottom"></span></a>
                ...
                <table class="uk-table uk-table-justify uk-table-middle uk-table-divider">
                  <tbody>
                    <tr class="uk-text-primary">
                      <td class="uk-table-expand"><span class="uk-margin-small-right" data-uk-icon="play-circle"></span><a href="#lesson1" data-uk-toggle>Introduction to Customer Support
            ...
            <li>
              <a class="uk-accordion-title" href="#">Overview of customer support roles and responsibilities 
...
<span class="uk-align-right uk-margin-remove-bottom"></span></a>
              <div class="uk-accordion-content">
                <table class="uk-table uk-table-justify uk-table-middle uk-table-divider">
                  <tbody>
                    <tr class="uk-text-primary">
                      <td class="uk-table-expand"><span class="uk-margin-small-right" data-uk-icon="play-circle"></span><a href="#lesson2" data-uk-toggle>Overview of customer support roles and responsibilities 
            ...
            <li>
              <a class="uk-accordion-title" href="#">Skills and qualities for effective customer support
...
<span class="uk-align-right uk-margin-remove-bottom"></span></a>
      ...
      >
            ...
            <li>
              <a class="uk-accordion-title" href="#">Verbal and Written communication techniques
...
<span class="uk-align-right uk-margin-remove-bottom"></span></a>
      ...
      >
            ...
            <li>
              <a class="uk-accordion-title" href="#">Empathy and understanding customer emotions
...
<span class="uk-align-right uk-margin-remove-bottom"></span></a>
      ...
      >
            ...
            <li>
              <a class="uk-accordion-title" href="#">Conflict resolution
...
<span class="uk-align-right uk-margin-remove-bottom"></span></a>
              <div class="uk-accordion-content">
                <table class="uk-table uk-table-justify uk-table-middle uk-table-divider">
                  <tbody>
                    <tr class="uk-text-primary">
                      <td class="uk-table-expand"><span class="uk-margin-small-right" data-uk-icon="play-circle"></span><a href="#lesson4" data-uk-toggle>An overview of social media management (1)
...
<div id="lesson1" class="uk-flex-top uk-modal-container" data-uk-modal>
  <div class="uk-modal-dialog uk-modal-body uk-margin-auto-vertical uk-light uk-background-secondary 
    ...
    <button class="uk-modal-close-outside" type="button" data-uk-close></button>
    <h2 class="uk-modal-title">Introduction to Customer Support
</h2>
