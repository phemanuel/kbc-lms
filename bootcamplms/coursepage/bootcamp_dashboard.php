...
<head>
  ...
  <title>Kings Branding Consult | Digital Literacy</title>
	      ...
	      <div class="uk-position-z-index" data-uk-navbar>
	        ...
	        <div class="uk-navbar-right">
	          <ul class="uk-navbar-nav uk-visible@m" data-uk-scrollspy-nav="closest: li; scroll: true; offset: 80">
	            <li class="uk-active"><a href="../pages/smm_check">Dashboard</a></li>
               <li class="uk-active"><a href="../pages/bootcamp_logout">Logout</a></li>
				...
				<li>
					...
					<div class="uk-position-cover uk-overlay-light uk-flex uk-flex-middle uk-padding-slide">
						<div class="uk-width-3-4@m">
							...
							<p>
								<a class="hvr-forward" href="#" data-uk-icon="icon: arrow-right"></a>
							</p>
						</div>
					</div>
				</li>
				<li>
					...
					<div class="uk-position-cover uk-overlay-xlight uk-flex uk-flex-middle uk-padding-slide">
						<div class="uk-width-1-2@m">
							<h1 class="uk-heading-medium uk-letter-spacing-medium">Learn New Skills</h1>
							<p>
								<a class="hvr-forward" href="#" data-uk-icon="icon: arrow-right"></a>
							</p>
						</div>
      ...
      <div>
        <div class="uk-card uk-card-small uk-card-default uk-card-hover uk-border-rounded-large uk-overflow-hidden">
          <div class="uk-card-media-top uk-inline uk-light">
            <img src="img/smm.png" alt="Course Title">
            <div class="uk-position-cover uk-overlay-xlight"></div>
            <div class="uk-position-small uk-position-top-left">
              <span class="uk-label uk-text-bold uk-text-price"></span>
            </div>
          ...
          <div class="uk-card-body">
            <h3 class="uk-card-title uk-margin-small-bottom">SOCIAL MEDIA MANAGEMENT</h3>
            <div class="uk-text-muted uk-text-small">KBC</div>
          ...
          <a href="../pages/smm_check" class="uk-position-cover"></a>
        </div>
      </div>
       ...
       <div>
        <div class="uk-card uk-card-small uk-card-default uk-card-hover uk-border-rounded-large uk-overflow-hidden">
          <div class="uk-card-media-top uk-inline uk-light">
            <img src="img/va.png" alt="Course Title">
            <div class="uk-position-cover uk-overlay-xlight"></div>
            <div class="uk-position-small uk-position-top-left">
              <span class="uk-label uk-text-bold uk-text-price"></span>
            </div>
          ...
          <div class="uk-card-body">
            <h3 class="uk-card-title uk-margin-small-bottom">VIRTUAL ASSISTANCE</h3>
            <div class="uk-text-muted uk-text-small">KBC</div>
            <div class="uk-text-muted uk-text-xxsmall uk-rating uk-margin-small-top">
              <span class="uk-rating-filled" data-uk-icon="icon: star; ratio: 0.75"></span>
              <span class="uk-rating-filled" data-uk-icon="icon: star; ratio: 0.75"></span>
          ...
          <a href="../pages/va_check" class="uk-position-cover"></a>
        </div>
      </div>
       ...
       <div>
        <div class="uk-card uk-card-small uk-card-default uk-card-hover uk-border-rounded-large uk-overflow-hidden">
          <div class="uk-card-media-top uk-inline uk-light">
            <img src="img/ld.png" alt="Course Title">
            <div class="uk-position-cover uk-overlay-xlight"></div>
            <div class="uk-position-small uk-position-top-left">
              <span class="uk-label uk-text-bold uk-text-price"></span>
            </div>
          ...
          <div class="uk-card-body">
            <h3 class="uk-card-title uk-margin-small-bottom">LEAD GENERATION</h3>
            <div class="uk-text-muted uk-text-small">KBC</div>
            <div class="uk-text-muted uk-text-xxsmall uk-rating uk-margin-small-top">
              <span class="uk-rating-filled" data-uk-icon="icon: star; ratio: 0.75"></span>
              <span class="uk-rating-filled" data-uk-icon="icon: star; ratio: 0.75"></span>
          ...
          <a href="../pages/ld_check" class="uk-position-cover"></a>
        </div>
      </div>
       ...
       <div>
        <div class="uk-card uk-card-small uk-card-default uk-card-hover uk-border-rounded-large uk-overflow-hidden">
          <div class="uk-card-media-top uk-inline uk-light">
            <img src="img/cs.png" alt="Course Title">
            <div class="uk-position-cover uk-overlay-xlight"></div>
            <div class="uk-position-small uk-position-top-left">
              <span class="uk-label uk-text-bold uk-text-price"></span>
            </div>
          ...
          <div class="uk-card-body">
            <h3 class="uk-card-title uk-margin-small-bottom">CUSTOMER SUPPORT</h3>
            <div class="uk-text-muted uk-text-small">KBC</div>
            <div class="uk-text-muted uk-text-xxsmall uk-rating uk-margin-small-top">
              <span class="uk-rating-filled" data-uk-icon="icon: star; ratio: 0.75"></span>
              <span class="uk-rating-filled" data-uk-icon="icon: star; ratio: 0.75"></span>
          ...
          <a href="../pages/cs_check" class="uk-position-cover"></a>
        </div>
      </div>

      <div class="uk-card uk-card-small uk-card-default uk-card-hover uk-border-rounded-large uk-overflow-hidden">
          <div class="uk-card-media-top uk-inline uk-light">
            <img src="img/fr.png" alt="Course Title">
            <div class="uk-position-cover uk-overlay-xlight"></div>
            <div class="uk-position-small uk-position-top-left">
              <span class="uk-label uk-text-bold uk-text-price"></span>
            </div>
          ...
          <div class="uk-card-body">
            <h3 class="uk-card-title uk-margin-small-bottom">FREELANCING</h3>
            <div class="uk-text-muted uk-text-small">KBC</div>
            <div class="uk-text-muted uk-text-xxsmall uk-rating uk-margin-small-top">
              <span class="uk-rating-filled" data-uk-icon="icon: star; ratio: 0.75"></span>
              <span class="uk-rating-filled" data-uk-icon="icon: star; ratio: 0.75"></span>
          ...
          <a href="../pages/fr_check" class="uk-position-cover"></a>
        </div>
      </div>
...
<div id="offcanvas" data-uk-offcanvas="flip: true; overlay: true">
  <div class="uk-offcanvas-bar">
    ...
    <div class="uk-margin-medium-top">
      <a class="uk-button uk-width-1-1 uk-button-primary-light" href="#">Sign In</a>
    </div>
