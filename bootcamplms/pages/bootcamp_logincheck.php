...
$sql1="SELECT * FROM training WHERE user_email='$useremail' and welcome_video= '1'";
...
window.location.href='bootcamp_login';
</script>";
...
d:
    ...
    if ($account_status == 1) {
         echo "<script>
window.location.href='../coursepage/bootcamp_dashboard';
</script>";
