      ...
      <div class="uk-width-expand@m">
        <div class="uk-article">          
          ...
          <ul class="uk-margin-top" data-uk-accordion="multiple: true">
            ...
            <li>
              <a class="uk-accordion-title" href="#">Introduction to Virtual Assistance
              ...
              <div class="uk-accordion-content">
                <table class="uk-table uk-table-justify uk-table-middle uk-table-divider">
                  <tbody>
                    ...
                    <tr class="uk-text-primary">
                      <td class="uk-table-expand"><span class="uk-margin-small-right" data-uk-icon="play-circle"></span><a href="#lesson2" data-uk-toggle>Overview of virtual assistance roles and responsibilities
                 ...
                 <li>
              <a class="uk-accordion-title" href="#">Communication and Professionalism for Virtual Assistance
...
<span class="uk-align-right uk-margin-remove-bottom"></span></a>
              <div class="uk-accordion-content">
                <table class="uk-table uk-table-justify uk-table-middle uk-table-divider">
                  <tbody>
                    <tr class="uk-text-primary">
                      <td class="uk-table-expand"><span class="uk-margin-small-right" data-uk-icon="play-circle"></span><a href="#lesson3" data-uk-toggle>Effective communication skills for virtual assistance
</a></td>
                    ...
                    <tr class="uk-text-primary">
                      <td class="uk-table-expand"><span class="uk-margin-small-right" data-uk-icon="play-circle"></span><a href="#lesson5" data-uk-toggle>Establishing boundaries and expectations with clients
              ...
              <li>
              <a class="uk-accordion-title" href="#">Time and Task Management For Efficient Virtual Assistance
...
<span class="uk-align-right uk-margin-remove-bottom"></span></a>
              <div class="uk-accordion-content">
                <table class="uk-table uk-table-justify uk-table-middle uk-table-divider">
                  <tbody>
                    <tr class="uk-text-primary">
                      <td>Efficient time management strategies for virtual assistance<iframe
      ...
      >
                    ...
                    <tr class="uk-text-primary">
                      <td class="uk-table-expand"><span class="uk-margin-small-right" data-uk-icon="play-circle"></span><a href="#lesson6" data-uk-toggle>Utilizing productivity tools and applications (Slack, Asana, Zendex, etc)1
                    ...
                    <tr class="uk-text-primary">
                      <td class="uk-table-expand"><span class="uk-margin-small-right" data-uk-icon="play-circle"></span><a href="#lesson7" data-uk-toggle>Utilizing productivity tools and applications (Slack, Asana, Zendex, etc)2
...
<span class="uk-align-right uk-margin-remove-bottom"></span></a>
              <div class="uk-accordion-content">
                <table class="uk-table uk-table-justify uk-table-middle uk-table-divider">
                  <tbody>
                    <tr class="uk-text-primary">
                      <td>Creating and maintaining organized virtual workspaces<iframe
        src="https://drive.google.com/file/d/1KDr0C0YB-hBJBUeBEgOb61zVSvAKbTsT/preview"
        width="100%"
        height="500px"
      >
                    ...
                    <tr class="uk-text-primary">
                      <td>File organization and naming conventions<iframe
        src="https://drive.google.com/file/d/1KDr0C0YB-hBJBUeBEgOb61zVSvAKbTsT/preview"
        width="100%"
        height="500px"
      >
                    ...
                    <tr class="uk-text-primary">
                      <td>Managing documents, folders, and digital assets<iframe
        src="https://drive.google.com/file/d/1KDr0C0YB-hBJBUeBEgOb61zVSvAKbTsT/preview"
        width="100%"
        height="500px"
      >
                    ...
                    <tr class="uk-text-primary">
                      <td class="uk-table-expand"><span class="uk-margin-small-right" data-uk-icon="play-circle"></span><a href="#lesson8" data-uk-toggle>Cloud storage and backup solutions
            ...
            <li>
              <a class="uk-accordion-title" href="#">Research and Data Gathering
...
<span class="uk-align-right uk-margin-remove-bottom"></span></a>
              <div class="uk-accordion-content">
                <table class="uk-table uk-table-justify uk-table-middle uk-table-divider">
                  <tbody>
                    <tr class="uk-text-primary">
                      <td class="uk-table-expand"><span class="uk-margin-small-right" data-uk-icon="play-circle"></span><a href="#lesson9" data-uk-toggle>Conducting effective online research
                    ...
                    <tr class="uk-text-primary">
                      <td>Validating and verifying sources<iframe
        src="https://drive.google.com/file/d/1KDr0C0YB-hBJBUeBEgOb61zVSvAKbTsT/preview"
        width="100%"
        height="500px"
      >
                    ...
                    <tr class="uk-text-primary">
                      <td>Summarizing and presenting research findings<iframe
        src="https://drive.google.com/file/d/1KDr0C0YB-hBJBUeBEgOb61zVSvAKbTsT/preview"
        width="100%"
        height="500px"
      >
...
<span class="uk-align-right uk-margin-remove-bottom"></span></a>
              <div class="uk-accordion-content">
                <table class="uk-table uk-table-justify uk-table-middle uk-table-divider">
                  <tbody>
                    <tr class="uk-text-primary">
                      <td class="uk-table-expand"><span class="uk-margin-small-right" data-uk-icon="play-circle"></span><a href="#lesson10" data-uk-toggle>Managing emails, scheduling, and calendar management
                    ...
                    <tr class="uk-text-primary">
                      <td>Data entry and database management<iframe
        src="https://drive.google.com/file/d/1KDr0C0YB-hBJBUeBEgOb61zVSvAKbTsT/preview"
        width="100%"
        height="500px"
      >
                    ...
                    <tr class="uk-text-primary">
                      <td>Online meeting coordination and note-taking<iframe
        src="https://drive.google.com/file/d/1KDr0C0YB-hBJBUeBEgOb61zVSvAKbTsT/preview"
        width="100%"
        height="500px"
      >
                     ...
                     <tr class="uk-text-primary">
                      <td class="uk-table-expand"><span class="uk-margin-small-right" data-uk-icon="play-circle"></span><a href="#lesson11" data-uk-toggle>Travel and event planning
...
<span class="uk-align-right uk-margin-remove-bottom"></span></a>
              <div class="uk-accordion-content">
                <table class="uk-table uk-table-justify uk-table-middle uk-table-divider">
                  <tbody>
                    <tr class="uk-text-primary">
                      <td>Tracking expenses and income for clients<iframe
        src="https://drive.google.com/file/d/1KDr0C0YB-hBJBUeBEgOb61zVSvAKbTsT/preview"
        width="100%"
        height="500px"
      >
                    ...
                    <tr class="uk-text-primary">
                      <td>Financial report generation and analysis<iframe
        src="https://drive.google.com/file/d/1KDr0C0YB-hBJBUeBEgOb61zVSvAKbTsT/preview"
        width="100%"
        height="500px"
      >
                    ...
                    <tr class="uk-text-primary">
                      <td class="uk-table-expand"><span class="uk-margin-small-right" data-uk-icon="play-circle"></span><a href="#lesson12" data-uk-toggle>Working through unfamiliar tasks
</a></td>
                      <td><span data-uk-icon="unlock"></span></td>
                      <td class="uk-table-shrink"></td>
                    </tr>     
                    <tr class="uk-text-primary">
                      <td>Places to learn online<iframe
        src="https://drive.google.com/file/d/1KDr0C0YB-hBJBUeBEgOb61zVSvAKbTsT/preview"
        width="100%"
        height="500px"
      >
...
<div id="lesson2" class="uk-flex-top uk-modal-container" data-uk-modal>
  <div class="uk-modal-dialog uk-modal-body uk-margin-auto-vertical uk-light uk-background-secondary 
    uk-border-rounded-large">
    <button class="uk-modal-close-outside" type="button" data-uk-close></button>
    <h2 class="uk-modal-title">Overview of virtual assistance roles and responsibilities
</h2>
      <iframe src="https://www.youtube.com/embed/IBFnojCtBnM" width="1000" height="562" data-uk-responsive data-uk-video></iframe>
    <div class="uk-margin-top uk-article uk-text-muted">
...
<div id="lesson3" class="uk-flex-top uk-modal-container" data-uk-modal>
  <div class="uk-modal-dialog uk-modal-body uk-margin-auto-vertical uk-light uk-background-secondary 
    uk-border-rounded-large">
    <button class="uk-modal-close-outside" type="button" data-uk-close></button>
    <h2 class="uk-modal-title">Effective communication skills for virtual assistance
</h2>
      <iframe src="https://www.youtube.com/embed/IBFnojCtBnM" width="1000" height="562" data-uk-responsive data-uk-video></iframe>
    <div class="uk-margin-top uk-article uk-text-muted">
...
<div id="lesson5" class="uk-flex-top uk-modal-container" data-uk-modal>
  <div class="uk-modal-dialog uk-modal-body uk-margin-auto-vertical uk-light uk-background-secondary 
    uk-border-rounded-large">
    <button class="uk-modal-close-outside" type="button" data-uk-close></button>
    <h2 class="uk-modal-title">Establishing boundaries and expectations with clients
</h2>
      <iframe src="https://www.youtube.com/embed/IBFnojCtBnM" width="1000" height="562" data-uk-responsive data-uk-video></iframe>
    <div class="uk-margin-top uk-article uk-text-muted">
...
<div id="lesson6" class="uk-flex-top uk-modal-container" data-uk-modal>
  <div class="uk-modal-dialog uk-modal-body uk-margin-auto-vertical uk-light uk-background-secondary 
    uk-border-rounded-large">
    <button class="uk-modal-close-outside" type="button" data-uk-close></button>
    <h2 class="uk-modal-title">Utilizing productivity tools and applications (Slack, Asana, Zendex, etc)1
</h2>
      <iframe src="https://www.youtube.com/embed/IBFnojCtBnM" width="1000" height="562" data-uk-responsive data-uk-video></iframe>
    <div class="uk-margin-top uk-article uk-text-muted">
...
<div id="lesson7" class="uk-flex-top uk-modal-container" data-uk-modal>
  <div class="uk-modal-dialog uk-modal-body uk-margin-auto-vertical uk-light uk-background-secondary 
    uk-border-rounded-large">
    <button class="uk-modal-close-outside" type="button" data-uk-close></button>
    <h2 class="uk-modal-title">Utilizing productivity tools and applications (Slack, Asana, Zendex, etc)2
</h2>
      <iframe src="https://www.youtube.com/embed/IBFnojCtBnM" width="1000" height="562" data-uk-responsive data-uk-video></iframe>
    <div class="uk-margin-top uk-article uk-text-muted">
