      ...
      <div class="uk-width-expand@m">
        <div class="uk-article">          
          ...
          <ul class="uk-margin-top" data-uk-accordion="multiple: true">
            ...
            <li>
              <a class="uk-accordion-title" href="#">Introduction to Lead Generation
...
<span class="uk-align-right uk-margin-remove-bottom"></span></a>
                ...
                <table class="uk-table uk-table-justify uk-table-middle uk-table-divider">
                  <tbody>
                    <tr class="uk-text-primary">
                      <td>Definition and importance of lead generation<iframe
      ...
      >
                    ...
                    <tr class="uk-text-primary">
                      <td class="uk-table-expand"><span class="uk-margin-small-right" data-uk-icon="play-circle"></span><a href="#lesson2" data-uk-toggle>Different types of leads and their significance
                    ...
                    <tr class="uk-text-primary">
                      <td>Understanding target audience and buyer personas<iframe
        src="https://drive.google.com/file/d/1KDr0C0YB-hBJBUeBEgOb61zVSvAKbTsT/preview"
        width="100%"
        height="500px"
      >
...
<span class="uk-align-right uk-margin-remove-bottom"></span></a>
              <div class="uk-accordion-content">
                <table class="uk-table uk-table-justify uk-table-middle uk-table-divider">
                  <tbody>
                    <tr class="uk-text-primary">
                      <td class="uk-table-expand"><span class="uk-margin-small-right" data-uk-icon="play-circle"></span><a href="#lesson3" data-uk-toggle>Inbound lead generation
</a></td>
                      ...
                      <td class="uk-table-shrink"></td>
                       ...
                       <tr class="uk-text-primary">
                      <td>Outbound lead generation<iframe
        src="https://drive.google.com/file/d/1KDr0C0YB-hBJBUeBEgOb61zVSvAKbTsT/preview"
        width="100%"
        height="500px"
      >
                    ...
                    <tr class="uk-text-primary">
                      <td>Social media lead generation<iframe
        src="https://drive.google.com/file/d/1KDr0C0YB-hBJBUeBEgOb61zVSvAKbTsT/preview"
        width="100%"
        height="500px"
      >
                    ...
                    <tr class="uk-text-primary">
                      <td>Networking and referrals for lead generation<iframe
        src="https://drive.google.com/file/d/1KDr0C0YB-hBJBUeBEgOb61zVSvAKbTsT/preview"
        width="100%"
        height="500px"
      >
              ...
              <li>
              <a class="uk-accordion-title" href="#">Tools and Software for Lead Generation
...
<span class="uk-align-right uk-margin-remove-bottom"></span></a>
              <div class="uk-accordion-content">
                <table class="uk-table uk-table-justify uk-table-middle uk-table-divider">
                  <tbody>
                    <tr class="uk-text-primary">
                      <td>Overview of popular lead generation tools and software<iframe
        src="https://drive.google.com/file/d/1KDr0C0YB-hBJBUeBEgOb61zVSvAKbTsT/preview"
        width="100%"
        height="500px"
      >
                    ...
                    <tr class="uk-text-primary">
                      <td class="uk-table-expand"><span class="uk-margin-small-right" data-uk-icon="play-circle"></span><a href="#lesson4" data-uk-toggle>Hubspot
                    ...
                    <tr class="uk-text-primary">
                      <td>Web scraping and data extraction tools<iframe
        src="https://drive.google.com/file/d/1KDr0C0YB-hBJBUeBEgOb61zVSvAKbTsT/preview"
        width="100%"
        height="500px"
      >
...
<span class="uk-align-right uk-margin-remove-bottom"></span></a>
              <div class="uk-accordion-content">
                <table class="uk-table uk-table-justify uk-table-middle uk-table-divider">
                  <tbody>
                     <tr class="uk-text-primary">
                      <td class="uk-table-expand"><span class="uk-margin-small-right" data-uk-icon="play-circle"></span><a href="#lesson7" data-uk-toggle>Writing compelling headlines and subject lines
                    ...
                    <tr class="uk-text-primary">
                      <td>Crafting persuasive sales copy and call-to-action (CTA) statements<iframe
        src="https://drive.google.com/file/d/1KDr0C0YB-hBJBUeBEgOb61zVSvAKbTsT/preview"
        width="100%"
        height="500px"
      >
                    ...
                    <tr class="uk-text-primary">
                      <td>Adapting writing style for different channels<iframe
        src="https://drive.google.com/file/d/1KDr0C0YB-hBJBUeBEgOb61zVSvAKbTsT/preview"
        width="100%"
        height="500px"
      >
                    ...
                    <tr class="uk-text-primary">
                      <td>A/B testing and optimizing copy for higher conversions<iframe
        src="https://drive.google.com/file/d/1KDr0C0YB-hBJBUeBEgOb61zVSvAKbTsT/preview"
        width="100%"
        height="500px"
      >
            ...
            <li>
              <a class="uk-accordion-title" href="#">Lead Qualification and Follow-up
...
<span class="uk-align-right uk-margin-remove-bottom"></span></a>
              <div class="uk-accordion-content">
                <table class="uk-table uk-table-justify uk-table-middle uk-table-divider">
                  <tbody>
                    <tr class="uk-text-primary">
                      <td class="uk-table-expand"><span class="uk-margin-small-right" data-uk-icon="play-circle"></span><a href="#lesson8" data-uk-toggle>Qualifying leads based on defined criteria
                    ...
                    <tr class="uk-text-primary">
                      <td>Lead scoring techniques for prioritization<iframe
        src="https://drive.google.com/file/d/1KDr0C0YB-hBJBUeBEgOb61zVSvAKbTsT/preview"
        width="100%"
        height="500px"
      >
                    ...
                    <tr class="uk-text-primary">
                      <td class="uk-table-expand"><span class="uk-margin-small-right" data-uk-icon="play-circle"></span><a href="#lesson9" data-uk-toggle>Implementing lead nurturing strategies to move leads through the sales funnel
                    ...
                    <tr class="uk-text-primary">
                      <td>Following up with leads using various communication channels<iframe
        src="https://drive.google.com/file/d/1KDr0C0YB-hBJBUeBEgOb61zVSvAKbTsT/preview"
        width="100%"
        height="500px"
      >
...
<div id="lesson3" class="uk-flex-top uk-modal-container" data-uk-modal>
  <div class="uk-modal-dialog uk-modal-body uk-margin-auto-vertical uk-light uk-background-secondary 
    uk-border-rounded-large">
    <button class="uk-modal-close-outside" type="button" data-uk-close></button>
    <h2 class="uk-modal-title">Inbound lead generation
</h2>
      <iframe src="https://www.youtube.com/embed/IBFnojCtBnM" width="1000" height="562" data-uk-responsive data-uk-video></iframe>
    <div class="uk-margin-top uk-article uk-text-muted">
...
<div id="lesson4" class="uk-flex-top uk-modal-container" data-uk-modal>
  <div class="uk-modal-dialog uk-modal-body uk-margin-auto-vertical uk-light uk-background-secondary 
    uk-border-rounded-large">
    <button class="uk-modal-close-outside" type="button" data-uk-close></button>
    <h2 class="uk-modal-title">Hubspot
</h2>
      <iframe src="https://www.youtube.com/embed/IBFnojCtBnM" width="1000" height="562" data-uk-responsive data-uk-video></iframe>
    <div class="uk-margin-top uk-article uk-text-muted">
...
<div id="lesson7" class="uk-flex-top uk-modal-container" data-uk-modal>
  <div class="uk-modal-dialog uk-modal-body uk-margin-auto-vertical uk-light uk-background-secondary 
    uk-border-rounded-large">
    <button class="uk-modal-close-outside" type="button" data-uk-close></button>
    <h2 class="uk-modal-title">Writing compelling headlines and subject lines
</h2>
      <iframe src="https://www.youtube.com/embed/IBFnojCtBnM" width="1000" height="562" data-uk-responsive data-uk-video></iframe>
    <div class="uk-margin-top uk-article uk-text-muted">
