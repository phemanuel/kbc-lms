...
<head>
  ...
  <title>Kings Branding Consult | Welcome</title>
      ...
      <div class="uk-width-1-3@m">
        <div data-uk-sticky="offset: 100; bottom: true; media: @m">
          <div class="uk-card uk-card-default uk-card-body uk-width-1-1 uk-border-rounded-large">
           ...
           <button class="uk-button uk-button-primary-preserve uk-button-medium uk-width-1-1" type="Submit">Submit</button> 
            </form>
...
<div id="offcanvas" data-uk-offcanvas="flip: true; overlay: true">
  <div class="uk-offcanvas-bar">
    <a class="uk-logo" href="#">Kings Branding Consult</a>
